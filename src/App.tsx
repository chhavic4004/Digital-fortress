...
import InstantAction from "./pages/InstantAction";
import AwarenessFeed from "./pages/AwarenessFeed";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/instant-action" element={<InstantAction />} />
            <Route path="/awareness-feed" element={<AwarenessFeed />} />
            <Route path="/timelock" element={<TimeLock />} />
            <Route path="/time-lock" element={<TimeLock />} />
